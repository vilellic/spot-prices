...
test("test time is in list range", () => {
  expect(
    utils.dateIsInPricesList(
      prices.today,
      dateUtils.parseISODate("2023-09-12T05:03:42+0300"),
    ),
  ).toBe(true);
  expect(
    utils.dateIsInPricesList(
      prices.today,
      dateUtils.parseISODate("2023-09-12T00:00:00+0300"),
    ),
  ).toBe(true);
  expect(
    utils.dateIsInPricesList(
      prices.today,
      dateUtils.parseISODate("2023-09-12T23:59:59+0300"),
    ),
  ).toBe(true);
  expect(
    utils.dateIsInPricesList(
      prices.today,
      dateUtils.parseISODate("2023-09-13T02:11:07+0300"),
    ),
  ).toBe(false);
  expect(
    utils.dateIsInPricesList(
      prices.today,
      dateUtils.parseISODate("2023-09-11T13:42:22+0300"),
    ),
  ).toBe(false);
  expect(
    utils.dateIsInPricesList(
      prices.today,
      dateUtils.parseISODate("2023-09-11T23:59:59+0300"),
    ),
  ).toBe(false);
});
